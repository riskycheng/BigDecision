...
extension DeveloperToolsSupport.ColorResource {
    ...
    static let appSecondary = DeveloperToolsSupport.ColorResource(name: "AppSecondary", bundle: resourceBundle)
...
extension AppKit.NSColor {
    ...
    /// The "AppSecondary" asset catalog color.
    static var appSecondary: AppKit.NSColor {
#if !targetEnvironment(macCatalyst)
        .init(resource: .appSecondary)
#else
        .init()
#endif
    }
...
extension UIKit.UIColor {
    ...
    /// The "AppSecondary" asset catalog color.
    static var appSecondary: UIKit.UIColor {
#if !os(watchOS)
        .init(resource: .appSecondary)
#else
        .init()
...
extension SwiftUI.Color {
    ...
    /// The "AppSecondary" asset catalog color.
    static var appSecondary: SwiftUI.Color { .init(.appSecondary) }
